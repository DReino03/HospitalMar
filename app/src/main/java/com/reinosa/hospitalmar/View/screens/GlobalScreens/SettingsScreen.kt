...
@Composable
fun SettingsScreen(navController: NavController, viewModel: LoginViewModel) {
    ...
    Scaffold(
        ...
        topBar = {
            TopAppBar(
                title = { androidx.compose.material.Text(text = stringResource(R.string.drawer_settings)) },
                navigationIcon = {
                    IconButton(onClick = {
                        scope.launch {
